...
def stackDeck3PFlush():
    deck.deck[0] = Card(2,"Diamonds", 1)
    deck.deck[1] = Card(3,"Diamonds", 2)
    deck.deck[2] = Card(10,"Diamonds", 3)
    deck.deck[3] = Card(9,"Diamonds", 4)
    deck.deck[4] = Card(10,"Clubs", 5)
    deck.deck[5] = Card(10,"Spades", 6)
    deck.deck[6] = Card(8,"Diamonds", 7)
    deck.deck[7] = Card(4,"Diamonds", 8)
    deck.deck[8] = Card(5,"Diamonds", 9)
    deck.deck[9] = Card(6,"Diamonds", 10)
    deck.deck[10] = Card(7,"Diamonds", 11)
def stackDeck3PPairEach():
    deck.deck[0] = Card(2,"Clubs", 1)
    deck.deck[1] = Card(3,"Spades", 2)
    deck.deck[2] = Card(10,"Clubs", 3)
    deck.deck[3] = Card(9,"Spades", 4)
    deck.deck[4] = Card(8,"Hearts", 5)
    deck.deck[5] = Card(5,"Diamonds", 6)
    deck.deck[6] = Card(6,"Hearts", 7)
    deck.deck[7] = Card(4,"Spades", 8)
    deck.deck[8] = Card(5,"Clubs", 9)
    deck.deck[9] = Card(10,"Spades", 10)
    deck.deck[10] = Card(2,"Spades", 11)
